    ...
    <table class="table table-bordered table-striped text-center">
      ...
      <tbody>
        <tr v-for="student in students" :key="student.id">
          ...
          <td>{{ student.city }}</td>
          <td>
              <i class="fa-solid fa-pen-to-square" data-toggle="modal" data-target="#updateModal" @click="setUpdateData(student)"></i>
            |
              <i class="fa-solid fa-circle-xmark " @click="deleteStudent(student.id)" ></i>
...
.fa-pen-to-square:hover , .fa-circle-xmark:hover{
    cursor: pointer;
}
</style>